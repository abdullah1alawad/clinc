...
@section('head')
    @parent
    @vite(['resources/sass/app.scss', 'resources/js/app.js', 'resources/js/assistantProfileEdit.js'])
@endsection
...
@section('content')
    ...
    <div class="container emp-profile">
        ...
        <div class="container emp-profile">
            <div class="row">
                <div class="col-md-4">
                    <form action="{{route('assistant.change.photo')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                ...
                <div class="col-md-2">
                    <a href="{{route('assistant.profile')}}" class="profile-edit-btn">Profile</a>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="tab-content profile-tab" id="myTabContent">
                        <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="about-tab">
                            <form action="{{route('assistant.profile.update')}}" method="post">
                                @method('put')
                                @csrf
                                <div class="row py-1">
                                    <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="changePassword" role="tabpanel"
                            ...
                            <form action="{{route('assistant.change.password')}}" method="post">
                                @csrf
                                @method('put')
                                <div class="row py-2">
                                    <div class="col-md-6">
