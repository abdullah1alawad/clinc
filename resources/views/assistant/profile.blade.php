                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="upcomingAppointments-tab" data-toggle="tab"
                                       ...
                                       aria-controls="upcomingAppointments" aria-selected="false">Your Upcoming
                                        Appointments</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="tab-pane fade" id="completedAppointments" role="tabpanel"
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center;">
                                    ...
                                    <form method="GET" action="{{ route('assistant.profile') }}">
                                        ...
                                        <button type="submit" class="btn btn-primary" style="margin-left: 5px">Filter
                                        </button>
                                    </form>
                                </div>
                                ...
                                <div class="message-table">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="2" class="text-end">
                                                <form method="GET" action="{{ route('assistant.profile') }}">
                                                    ...
                                                    <button type="submit" id="msg_btn" class="btn btn-outline-dark">
                                                        Unread
                                                        Messages
                                                        Only
                                                    </button>
                                        ...
                                        @foreach($messages as $message)
                                            @if(!$message->read_at)
                                                <tr class="alert alert-success notify-item"
                                                ...
                                                <tr class="alert alert-dark">
                                                    ...
                                                    <td>
                                                        @if($message->data['title'] == 'new process')
                                                            [{{$message->created_at}}]
                                                            Doctor ({{$message->data['doctor_name']}}) has been assigned
                                                            you for
                                                            assistant
                                                        @else
                                                            [{{$message->created_at}}]
                                                            {{$message->data['how']}} has canceled an appointment for
                                                            which you
                                                            are assistant.
                                                        @endif
                                                    </td>
