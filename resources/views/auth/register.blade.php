                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="radio-container">
                                    <input type="radio" id="male" class=" @error('gender') is-invalid @enderror" name="gender" value="0" required autocomplete="gender" autofocus checked>
                                    <label for="male">Male</label>
                                </div>

                                <div class="radio-container">
                                    <input type="radio" id="female" class=" @error('gender') is-invalid @enderror" name="gender" value="1" required autocomplete="gender" autofocus>
