  ...
  <main id="main">
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Level:</strong> <span>{{$user->student->level}}</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Semester:</strong> <span>{{$user->student->semester}}</span></li>
                </ul>
              </div>
            </div>
    ...
    <section id="facts" class="facts">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Progress</h2>
           <p>The topics and the number of completed tasks</p>
        </div>
